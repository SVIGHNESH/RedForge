...
| [T0.07](t0-07-store-types.md) | Store types, Entry, Value, Clock, map store | M3 | T0.01 | 3 h | Merged (PR #80) |
| [T0.08](t0-08-seq-and-propagate.md) | Sequence counter and Propagate hook | M7, M8 | T0.06, T0.07 | 2 h | Merged (PR #81) |
